                        ...
                        <tbody>
                            ...
                            foreach ($bookingroomlist as $bookingroom) {
                                ...
                                if ($bookingroom['roomId'] == "") {
                                    echo "<td><a href='bookingroom2.php?brIdToAssign=$brId&&wardIdToAssign=$spec_array[0]&&rtIdToAssign=$spec_array[1]' class='btn btn-primary'><i class='far fa-calendar-plus'></i> Assign</a>
                                    ...
                                    <a href='bookingroom2.php?brIdToUnAssign=$brId&&roomIdToUnAssign=$roomId' class='btn btn-primary'><i class='far fa-calendar-plus'></i> Unassign</a></td>";
                                }
                        ...
                        <div class="form-group col-12 mb-2">
                            ...
                            <select class="form-select" name="tfRoomId" aria-label="Default select example" required>
                                ...
                                if (isset($_REQUEST['brIdToAssign'])) {
                                    ...
                                    echo "<option>$wardIdToAssign | $rtIdToAssign</option>";
...
<?php
                                ...
                                $selectrt = "SELECT r.*,w.*,rt.* from room r,ward w,roomtype rt where r.wardId=w.wardId and r.rtId=rt.rtId and w.wardId=$wardIdToAssign and rt.rtId=$rtIdToAssign";
